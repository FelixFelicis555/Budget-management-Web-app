...
class UpdateProfileForm(forms.Form):
	name = forms.CharField(max_length=500 , widget=forms.TextInput(attrs={'id':'name','class':'text_field'}) )
	phone = forms.CharField(max_length=500 , widget=forms.TextInput(attrs={'id':'phone','class':'text_field'}) )
	address = forms.CharField(max_length=500 , widget=forms.TextInput(attrs={'id':'address','class':'text_field'}) )
